...
typedef enum
{
  ...
  TYPE_STRING,
  TYPE_FLOAT64,
  TYPE_BOOLEAN, // BOOLEAN EXTENSION
  ...
  TYPE_DIVIDE,
  TYPE_MODULO,
  //TYPE_INCREMENT, NOT SURE IF WILL BE USED
  //TYPE_DECREMENT

  // RELATIONAL OPERATORS
  TYPE_EQUALS, // 14 // not sure if [NOT] EQUALS should be used
  TYPE_NOT_EQUALS,
  TYPE_GREATER,
  TYPE_LESSER,
  //TYPE_GREATER_OR_EQUAL, NOT SURE IF WILL BE USED
