...
typedef enum
{
  ...
  STATE_DIGIT_NEGATIVE_WITH_EXP,
  STATE_DIGIT_NEGATIVE_WITH_EXP_AND_OP,
  STATE_FLOAT,
  STATE_FLOAT_WITH_EXP,
  STATE_FLOAT_WITH_EXP_AND_OP,
  STATE_FLOAT_NEGATIVE,
  STATE_FLOAT_NEGATIVE_WITH_EXP,
  STATE_FLOAT_NEGATIVE_WITH_EXP_AND_OP,
